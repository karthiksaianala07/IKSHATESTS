    ...
    <div className="bg-[#04060B] text-slate-100 font-body min-h-screen flex flex-col selection:bg-cyan-500/30 selection:text-cyan-200 relative">
      ...
      >
        <div className="flex items-center gap-4 bg-slate-950/70 border border-slate-900/60 backdrop-blur-2xl shadow-2xl rounded-2xl px-5 py-2.5">
          <Link to="/" className="flex items-center gap-2 border border-slate-800/80 px-2.5 py-1.5 rounded-xl bg-slate-950/60">
            <Logo className="h-5 w-auto grayscale contrast-200" />
          </Link>
          ...
          <nav className="flex items-center gap-1">
            {location.pathname === '/' ? (
              <>
                <a href="#sec-services" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">Plans</a>
                <Link to="/exams" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">Exam</Link>
              ...
              <>
                <Link to="/exams" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">Exams</Link>
                <Link to="/jee-library" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">JEE Mocks</Link>
                <Link to="/neet-library" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">NEET Mocks</Link>
                <Link to="/dashboard" className="px-3 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white hover:bg-slate-900/30 transition-all">Dashboard</Link>
              </>
            )}
          </nav>
      ...
      >
        <Logo className="h-4 w-auto grayscale contrast-200" />
      ...
      <main className={`${location.pathname === '/' ? 'pt-0' : 'pt-28 md:pt-32'} flex-1 flex flex-col min-h-screen bg-transparent relative z-10`}>
        <div className="flex-1 w-full">
          <Routes>
            ...
            <Route path="/dashboard" element={<div className="p-4 md:p-8 min-h-[calc(100vh-4rem)]"><Dashboard /></div>} />
