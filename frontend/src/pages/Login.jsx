        ...
        {step === 'email' && (
          <form onSubmit={handleEmailSubmit} className="space-y-6">
            ...
            <button 
              ...
              className="w-full mt-4 py-3.5 bg-red-950/60 hover:bg-red-900 border border-red-900 text-red-300 font-bold rounded-xl flex items-center justify-center gap-2 transition-colors cursor-pointer"
            >
