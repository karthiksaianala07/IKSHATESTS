...
(async () => {
  ...
  await page.fill('input[placeholder*="JEE Full Mock Paper"]', 'JEE Mock Test Real AI ' + new Date().toLocaleDateString());
  ...
  console.log('Waiting for extraction (this can take 30-90 seconds)...');
  // Wait for the text "Staged Questions (75)" to appear on the page
  await page.waitForSelector('text=Staged Questions (75)', { timeout: 300000 });
  console.log('Staged Questions (75) text found!');

  // Take screenshot of the extracted questions list
  const screenshotPath = 'C:/Users/KARTHIK SAI ANALA/.gemini/antigravity-ide/brain/3ca49147-ecfd-414c-aeed-d91ae916be0c/real_extracted_questions.png';
  ...
  const finalScreenshotPath = 'C:/Users/KARTHIK SAI ANALA/.gemini/antigravity-ide/brain/3ca49147-ecfd-414c-aeed-d91ae916be0c/real_final_dashboard.png';
